...
const prerequisites: PrerequisiteGate[] = [
  ...
  },
  {
    ...
    description: 'The production feature pins to a specific promoted TIBER-Data artifact identity (path + sha256 + promotion review) and fails closed on mismatch.',
    satisfied: true,
    evidence:
      'docs/reports/player-history-2024-from-2021-2023-mirror-refresh-2026-07-07.json records promotedArtifactSha256Pinned === promotedArtifactSha256Actual (d45f612b...) with sha256_verified_fail_closed_by_generator=true, promotion TIBER-Data#202/#207.',
  },
  {
  ...
  },
  {
    ...
    description: 'The deterministic replay commands for the cited evidence have been exercised by the reviewer, not just read.',
    satisfied: true,
    evidence: 'This review ran `npm run build` and `npm test` against the committed tree (74 test files, 927 tests passing) before writing this report.',
  },
  {
