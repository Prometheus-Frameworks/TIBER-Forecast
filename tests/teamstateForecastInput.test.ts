...
describe('governed Teamstate Forecast input boundary', () => {
  ...
  it('allows pressure readiness count metadata without accepting pressure feature values', () => {
    const result = readGovernedTeamstateInput({
      ...governedTeamstate,
      pressure: null,
      field_readiness: {
        ...governedTeamstate.field_readiness,
        pressure: {
          availability: 'unavailable',
          reason: 'insufficient_data',
          timing: 'deferred',
          field: 'pressureRateAllowed',
          finiteCount: 0,
          nullCount: 544,
          rowCount: 544,
  ...
  it('still rejects numeric pressure feature values inside pressure readiness payloads', () => {
    const result = readGovernedTeamstateInput({
      ...governedTeamstate,
      field_readiness: {
        ...governedTeamstate.field_readiness,
