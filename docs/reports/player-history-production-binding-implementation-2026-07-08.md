...
| Dimension | Expected | Observed | Passed |
|---|---|---|---|
| build_and_tests_pass | build_passed=true, tests_passed=true | build_passed=true, tests_passed=true (78 files, 1032 tests) | ✅ |
